...
Catalog sync and local setup. Overview for GitHub visitors: [README.md](README.md).
...
[library guide](https://github.com/ChurchApps/WorshipCommonsContent/blob/main/LIBRARY.md)). Disaster recovery = repo → bucket sync + reseed from
